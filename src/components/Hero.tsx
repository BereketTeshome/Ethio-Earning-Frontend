        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-2xl font-bold leading-snug tracking-tight text-gray-800 lg:leading-tight xl:text-4xl dark:text-white">
              {language === "eng" ? "Empower Your Advertising" : "ማስታወቂያዎን በእኛ"}
              <br />
              <span style={{ color: "#4F46E5" }}>
                {language === "eng" ? "with Our Platform" : "መድረክ ያሳድጉ"}
              </span>
            </h1>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              >
                ...
                <span>{language === "eng" ? "Learn More" : "የበለጠ ለማወቅ"}</span>
              </a>
            </div>
          </div>
        </div>
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="">
            <Image
              ...
              alt="Advertising Platform Illustration"
              loading="eager"
              placeholder="blur"
            />
          </div>
